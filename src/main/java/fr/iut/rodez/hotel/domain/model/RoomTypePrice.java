...
public class RoomTypePrice {
     ...
     * Utilisé uniquement par la couche infrastructure (RoomTypePriceJpaEntity.toDomain).
     */
    public static RoomTypePrice reconstruct(Long id, LocalDate startDate, LocalDate endDate, BigDecimal pricePerNight) {
        RoomTypePrice p = new RoomTypePrice();
        p.id = id;
